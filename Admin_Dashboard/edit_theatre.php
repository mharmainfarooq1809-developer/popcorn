...
<body>
    ...
    <!-- Sidebar (make sure your sidebar.php includes the correct structure with submenus) -->
    ...
    <div class="main-content">
        <div class="container-fluid">
            ...
            <h2 class="mb-4">Edit Booking #<?= $booking_id ?></h2>
            ...
            <div class="row g-4">
                    ...
                    <div class="card">
                        ...
                        <form method="post">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="holder_name" value="<?= htmlspecialchars($booking['holder_name'] ?? '') ?>" required>
                            </div>
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <label class="form-label">Adults</label>
                                    <input type="number" class="form-control" name="adults" min="0" value="<?= $booking['adults'] ?>" required>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label class="form-label">Children</label>
                                    <input type="number" class="form-control" name="children" min="0" value="<?= $booking['children'] ?>" required>
                                </div>
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Seats (comma separated)</label>
                                <input type="text" class="form-control" name="seats" value="<?= htmlspecialchars($booking['seats']) ?>" required>
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Total Price ($)</label>
                                <input type="number" step="0.01" class="form-control" name="total_price" value="<?= number_format($booking['total_price'], 2) ?>" required>
                            </div>
                            <div class="mb-3 form-check">
                                <input type="checkbox" class="form-check-input" name="discount_applied" id="discount_applied" value="1" <?= $booking['discount_applied'] ? 'checked' : '' ?>>
                ...
                <div class="col-lg-6">
                    <div class="card">
                        <h4 class="mb-4">Related Information</h4>
                        <table class="table">
                            <tr>
                                <th>User</th>
                                <td><?= htmlspecialchars($booking['user_name']) ?> <br> <small><?= htmlspecialchars($booking['user_email']) ?></small></td>
                            </tr>
                            <tr>
                                <th>Movie</th>
                            ...
                            <tr>
                                <th>Showtime</th>
                                <td><?= htmlspecialchars($booking['show_date'] ?? 'N/A') ?> at <?= htmlspecialchars($booking['show_time'] ?? 'N/A') ?></td>
                            </tr>
                            <tr>
                                <th>Theatre</th>
                                <td><?= htmlspecialchars($booking['theatre'] ?? 'N/A') ?></td>
                            </tr>
                            <tr>
                                <th>Booking Date</th>
                        ...
                        <a href="ticket.php?booking_id=<?= $booking_id ?>" class="btn btn-outline-primary w-100" target="_blank">View Ticket</a>
                    </div>
                </div>
            </div>
