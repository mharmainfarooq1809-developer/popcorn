...
<body>
    ...
    <!-- Sidebar (make sure your sidebar.php has the Users submenu) -->
    ...
    <div class="main-content">
        <div class="container-fluid">
            ...
            <form id="addUserForm" class="card p-4" method="post">
                <div class="row g-3">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="url" class="form-control" name="profile_image" id="profile_image" placeholder="https://...">
                    </div>
                    <div class="col-md-6">
    ...
    <script>
        ...
        form.addEventListener('submit', function(e) {
            ...
            // If you want to submit to a separate endpoint (like add_user_process.php)
            // Use the URL below. If you want to submit to the same file, you can handle it
            // with PHP as well. Here we'll send to the backend script you provided.
            fetch('add_user_process.php', {  // adjust the path if needed
                method: 'POST',
                body: formData
            })
