...
<body>
        ...
        <div class="nav">
            ...
            <div class="nav-item">
                ...
                <div class="collapse show" id="theatresSubmenu">
                    <a href="theatres.php" class="nav-link submenu-link active"><i class="bi bi-list-ul"></i><span>All Theatres</span></a>
    ...
    <div class="main-content">
        ...
        <!-- Theatres Table -->
        <div class="card">
            <div class="card-header-with-toggle" data-target="theatresSection" data-default-expanded="true">
                <h5>All Theatres</h5>
                <i class="bi bi-chevron-right"></i>
            </div>
            <div class="toggle-content show" id="theatresSection">
                <div class="table-responsive">
                    <table class="table" id="theatresTable">
                        ...
                        <tbody>
                            <?php if ($theatres->num_rows > 0): ?>
                                <?php while ($row = $theatres->fetch_assoc()):
                                    ...
                                    <tr>
                                        ...
                                        <td>$<?= $row['price'] ?></td>
                                        <td>
                                            <?php if ($facilities_str): ?>
                                                <span class="badge badge-secondary"><?= htmlspecialchars($facilities_str) ?></span>
                                            <?php else: ?>
                                        ...
                                        <td>
                                            ...
                                            <a href="delete_theatre.php?id=<?= $row['id'] ?>" class="btn btn-sm btn-outline-danger"
                                                onclick="return confirm('Are you sure you want to delete this theatre?')" title="Delete">
                            ...
                            <?php else: ?>
                                <tr>
                                    <td colspan="9" class="text-center">No theatres found. <a href="add_theatre.php">Add your first theatre</a></td>
                                </tr>
                            <?php endif; ?>
                        </tbody>
                    </table>
