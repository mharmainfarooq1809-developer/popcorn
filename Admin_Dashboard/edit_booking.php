...
<body>
    ...
    <div class="main-content">
        <div class="container-fluid">
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-6">
                    <div class="card">
                        ...
                        <table class="table">
                            <tr>
                                ...
                                <td><?= htmlspecialchars($booking['user_name']) ?> <br>
                                    <small><?= htmlspecialchars($booking['user_email']) ?></small></td>
                            </tr>
                            <tr>
                                <th>Movie</th>
                            ...
                            <tr>
                                <th>Showtime</th>
                                <td><?= htmlspecialchars($booking['show_date'] ?? 'N/A') ?> at
                                    <?= htmlspecialchars($booking['show_time'] ?? 'N/A') ?></td>
                            </tr>
                            <tr>
                                <th>Theatre</th>
                        ...
                        <a href="ticket.php?booking_id=<?= $booking_id ?>" class="btn btn-outline-primary w-100"
            ...
            <div class="mt-4">
                <a href="bookings.php" class="btn btn-outline-secondary"><i class="bi bi-arrow-left"></i> Back to
                    Bookings</a>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        // (Optional) Keep bookings submenu open – if you have a submenu for bookings in sidebar.php
        (function () {
